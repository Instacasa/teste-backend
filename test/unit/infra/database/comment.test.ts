...
describe('Comment Repository', () => {
  ...
  test('Should get list of comment', async () => {
    ...
    let comment1: CommentInterface = new Comment({ text: 'text test', user, post });
    let comment2: CommentInterface = new Comment({ text: 'text test', user, post });
    let comment3: CommentInterface = new Comment({ text: 'text test', user, post });
