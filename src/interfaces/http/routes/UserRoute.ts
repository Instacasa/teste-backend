...
class UserRoute {
  ...
  createRouter = () => {
    ...
    this.router.patch('/:userId/edit/:id', userController.updateUser.bind(userController));
    this.router.delete('/:userId/remove/:id', userController.deleteUser.bind(userController));
    return this.router;
  };
